...
public class Odrzavanja_Old {
    ...
    public Odrzavanja_Old(Long idOdrzavanje, Radnik radnik, Oprema oprema, TipServisa tipServisa, Serviser serviser, String opisKvara, LocalDate datumPrijave, LocalDate datumOtpreme, LocalDate datumPovrata, LocalDate datumPlaniranogServisiranja) {
